...
challenge = Challenge.create(name: "One chapter", content: "Read one chapter or the first chapter of a book you chose", source: "Biqom", source_type: "Text", duration: 30, position: 0, activity_id: 1)
